...
public class RecalculateRoutesLines implements IObjectActionDelegate {

	private ISelection selection;

	public RecalculateRoutesLines() {
	}
		...
		if (project != null) {
			...
			try {
				...
				if (command != null) {
					...
					recalculateRoutesLinesAction(project);
				}
