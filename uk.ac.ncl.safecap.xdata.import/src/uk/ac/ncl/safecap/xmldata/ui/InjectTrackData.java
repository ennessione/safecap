...
public class InjectTrackData extends AbstractHandler {
...
//				DiagramEditPart diagramEditPart = util.createDiagramEditPart(diagram, PlatformUI.getWorkbench().getDisplay().getActiveShell(), PreferencesHint.USE_DEFAULTS);
				}

				InjectTrackDataStep.execute(data, prj);
