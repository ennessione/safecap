 ...
 * </p>
 * <ul>
 * <li>{@link safecap.config.MergedPointsConfiguration#getName
 * <em>Name</em>}</li>
 * <li>{@link safecap.config.MergedPointsConfiguration#getDelimiter
 * <em>Delimiter</em>}</li>
 * <li>{@link safecap.config.MergedPointsConfiguration#getCode
 * <em>Code</em>}</li>
 * </ul>
 *
 * @see safecap.config.ConfigPackage#getMergedPointsConfiguration()
 * @model
 * @extends ESerializableObject
 * @generated
 */
public interface MergedPointsConfiguration extends ESerializableObject {
	/**
	 ...
	 * @see #setName(String)
	 * @see safecap.config.ConfigPackage#getMergedPointsConfiguration_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	 ...
	 * @see safecap.config.ConfigPackage#getMergedPointsConfiguration_Delimiter()
	 * @model required="true"
	 * @generated
	 */
	String getDelimiter();
	 ...
	 * @see #setCode(String)
	 * @see safecap.config.ConfigPackage#getMergedPointsConfiguration_Code()
	 * @model required="true"
	 * @generated
	 */
	String getCode();
