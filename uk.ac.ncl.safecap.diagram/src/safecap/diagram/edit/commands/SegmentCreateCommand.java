...
public class SegmentCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SegmentCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return SafecapBaseItemSemanticEditPolicy.getLinkConstraints().canCreateSegment_4001(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		final Segment newElement = SchemaFactory.eINSTANCE.createSegment();
		getContainer().getSegments().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Segment newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
