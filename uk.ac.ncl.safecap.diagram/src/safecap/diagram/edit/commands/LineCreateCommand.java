...
public class LineCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LineCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final Line newElement = ModelFactory.eINSTANCE.createLine();

		final Model owner = (Model) getElementToEdit();
		owner.getLines().add(newElement);
