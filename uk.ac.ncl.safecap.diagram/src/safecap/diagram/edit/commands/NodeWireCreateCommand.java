 ...
 * @generated
 */
public class NodeWireCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NodeWireCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return SafecapBaseItemSemanticEditPolicy.getLinkConstraints().canCreateNodeWire_4004(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		final NodeWire newElement = TracksideFactory.eINSTANCE.createNodeWire();
		getContainer().getNodewires().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(NodeWire newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
