 ...
 * @generated
 */
public class RightSignalCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RightSignalCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final RightSignal newElement = TracksideFactory.eINSTANCE.createRightSignal();
	 ...
	 * @generated
	 */
	protected void doConfigure(RightSignal newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
