 ...
 * @generated
 */
public class LeftSpeedLimitCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public LeftSpeedLimitCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final LeftSpeedLimit newElement = TracksideFactory.eINSTANCE.createLeftSpeedLimit();
	 ...
	 * @generated
	 */
	protected void doConfigure(LeftSpeedLimit newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
