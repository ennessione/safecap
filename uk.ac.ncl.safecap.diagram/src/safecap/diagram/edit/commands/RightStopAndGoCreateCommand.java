 ...
 * @generated
 */
public class RightStopAndGoCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RightStopAndGoCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final RightStopAndGo newElement = TracksideFactory.eINSTANCE.createRightStopAndGo();
	 ...
	 * @generated
	 */
	protected void doConfigure(RightStopAndGo newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
