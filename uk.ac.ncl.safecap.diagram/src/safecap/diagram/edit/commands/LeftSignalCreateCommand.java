 ...
 * @generated
 */
public class LeftSignalCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public LeftSignalCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final LeftSignal newElement = TracksideFactory.eINSTANCE.createLeftSignal();
	 ...
	 * @generated
	 */
	protected void doConfigure(LeftSignal newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
