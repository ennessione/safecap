 ...
 * @generated
 */
public class StationCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public StationCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final Station newElement = CommentaryFactory.eINSTANCE.createStation();
	 ...
	 * @generated
	 */
	protected void doConfigure(Station newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
