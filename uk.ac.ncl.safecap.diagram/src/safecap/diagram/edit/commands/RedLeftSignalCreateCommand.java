 ...
 * @generated
 */
public class RedLeftSignalCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RedLeftSignalCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final RedLeftSignal newElement = TracksideFactory.eINSTANCE.createRedLeftSignal();
	 ...
	 * @generated
	 */
	protected void doConfigure(RedLeftSignal newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
