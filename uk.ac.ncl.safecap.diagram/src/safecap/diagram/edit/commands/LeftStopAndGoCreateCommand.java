 ...
 * @generated
 */
public class LeftStopAndGoCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public LeftStopAndGoCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final LeftStopAndGo newElement = TracksideFactory.eINSTANCE.createLeftStopAndGo();
	 ...
	 * @generated
	 */
	protected void doConfigure(LeftStopAndGo newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
