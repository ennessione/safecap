...
public class BridgeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final Bridge newElement = CommentaryFactory.eINSTANCE.createBridge();

		final Comments owner = (Comments) getElementToEdit();
		owner.getComments().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Bridge newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
