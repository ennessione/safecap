 ...
 * @generated
 */
public class SubSchemaNodeCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public SubSchemaNodeCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final SubSchemaNode newElement = SchemaFactory.eINSTANCE.createSubSchemaNode();
	 ...
	 * @generated
	 */
	protected void doConfigure(SubSchemaNode newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
