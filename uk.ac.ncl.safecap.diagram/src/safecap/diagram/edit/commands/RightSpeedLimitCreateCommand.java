 ...
 * @generated
 */
public class RightSpeedLimitCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public RightSpeedLimitCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		final RightSpeedLimit newElement = TracksideFactory.eINSTANCE.createRightSpeedLimit();
	 ...
	 * @generated
	 */
	protected void doConfigure(RightSpeedLimit newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
