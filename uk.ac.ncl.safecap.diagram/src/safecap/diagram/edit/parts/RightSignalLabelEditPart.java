 ...
 * @generated
 */
public class RightSignalLabelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(SafecapVisualIDRegistry.getType(safecap.diagram.edit.parts.RightSignalLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public RightSignalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SafecapParserProvider.getParser(SafecapElementTypes.RightSignal_2005, getParserElement(),
					SafecapVisualIDRegistry.getType(safecap.diagram.edit.parts.RightSignalLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
