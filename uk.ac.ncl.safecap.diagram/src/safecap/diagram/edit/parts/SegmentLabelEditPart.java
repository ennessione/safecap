 ...
 * @generated
 */
public class SegmentLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(SafecapVisualIDRegistry.getType(safecap.diagram.edit.parts.SegmentLabelEditPart.VISUAL_ID),
				new Point(0, 00));
	}
	 ...
	 * @generated
	 */
	public SegmentLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SafecapParserProvider.getParser(SafecapElementTypes.Segment_4001, getParserElement(),
					SafecapVisualIDRegistry.getType(safecap.diagram.edit.parts.SegmentLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
