 ...
 * @generated
 */
public class SubSchemaNodeLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SubSchemaNodeLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SafecapParserProvider.getParser(SafecapElementTypes.SubSchemaNode_2015, getParserElement(),
					SafecapVisualIDRegistry.getType(safecap.diagram.edit.parts.SubSchemaNodeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
