...
import uk.ac.ncl.safecap.diagram.misc.parts.FCStation;
...
public class StationEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		final OrientableCommentary n = (OrientableCommentary) StationEditPart.this.resolveSemanticElement();
		final EditPartViewer viewer = StationEditPart.this.getViewer();
		final RenderedDiagramRootEditPart root = (RenderedDiagramRootEditPart) viewer.getRootEditPart();
		final FANode fanode = new FCStation(n);
