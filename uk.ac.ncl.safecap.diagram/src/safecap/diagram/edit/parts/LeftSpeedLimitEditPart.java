 ...
 * @generated
 */
public class LeftSpeedLimitEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LeftSpeedLimitEditPart(View view) {
		super(view);
	}
	...
	protected void handleNotificationEvent(final Notification event) {
		...
		if (event.getNotifier() instanceof SpeedLimit && (event.getFeature().equals(TracksidePackage.eINSTANCE.getSpeedLimit_Limit())
				|| event.getFeature().equals(TracksidePackage.eINSTANCE.getSpeedLimit_Line()))) {
			super.refresh();
		}
	...
	public ConnectionAnchor getSourceConnectionAnchor(ConnectionEditPart arg0) {
		...
		fixedAnchor.offsetH = SpeedFigure.LEFT_ANCHOR_X;
		fixedAnchor.offsetV = SpeedFigure.LEFT_ANCHOR_Y;
		return fixedAnchor;
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LeftSpeedLimitFigDes();
	}

	/**
	 * @generated
	 */
	public LeftSpeedLimitFigDes getPrimaryShape() {
		return (LeftSpeedLimitFigDes) primaryShape;
	}
	 ...
	 * @generated NOT
	 */
	public class LeftSpeedLimitFigDes extends SpeedFigure {

		/**
		 * @generated NOT
		 */
		public LeftSpeedLimitFigDes() {
