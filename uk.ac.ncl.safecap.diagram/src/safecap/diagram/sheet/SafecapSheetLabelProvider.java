...
import safecap.diagram.navigator.SafecapNavigatorGroup;
 ...
 * @generated
 */
public class SafecapSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	public String getText(Object element) {
		...
		if (element instanceof SafecapNavigatorGroup) {
			return ((SafecapNavigatorGroup) element).getGroupName();
		}
	...
	public Image getImage(Object element) {
		...
		return etype == null ? null : SafecapElementTypes.getImage(etype);
	}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			final int vid = SafecapVisualIDRegistry.getVisualID(view);
			final IElementType etype = SafecapElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
