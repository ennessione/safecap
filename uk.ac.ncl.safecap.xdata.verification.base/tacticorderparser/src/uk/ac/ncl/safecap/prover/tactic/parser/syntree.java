...
public class syntree {
	...
	public syntree(int opcode, syntree r, synvalue val) {
		operation = opcode;
		siblings = new ArrayList<syntree>(1);
		add(r);
		value = val;
	...
	public syntree(int opcode, String synid, syntree r, synvalue val) {
		operation = opcode;
		siblings = new ArrayList<syntree>(1);
		add(r);
		value = val;
	...
	public syntree(int opcode, String synid, synvalue val) {
		operation = opcode;
		value = val;
		this.synid = synid;
	}

	public syntree(int opcode, String synid, syntree r) {
		operation = opcode;
		siblings = new ArrayList<syntree>(1);
		add(r);
		this.synid = synid;
	...
	public syntree(int opcode, String synid) {
		operation = opcode;
		this.synid = synid;
	}
	...
	public syntree setId(String synid) {
		this.synid = synid;
		return this;
	}
