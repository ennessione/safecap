...
public class BIFClosure1 extends BuiltinFunction {
	public static BIFClosure1 INSTANCE = new BIFClosure1();
	...
	public String compile(SDARuntimeExecutionContext context, CLCollection<CLExpression> arguments) throws CLNonExecutableException {
		return "(" + arguments.byIndex(0).compile(context) + ").toRel().closure1()";
	}
