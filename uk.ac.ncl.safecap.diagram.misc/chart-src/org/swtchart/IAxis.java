...
public interface IAxis {
	 ...
	 * @throws IllegalStateException if minimum value of series belonging to this
	 *                               axis is less than zero.
	 */
	...
	/**
	 * Gets the grid. The gird interval is identical with the position of axis tick
	 * marks. The horizontal grid is accessible from vertical axis, and the vertical
	 * grid is accessible from horizontal axis.
	 * 
	 ...
	 * 
	 * @param enabled true if enabling category
	 */
	...
	/**
	 * Adds the dispose listener. The newly created color or font for axis can be
