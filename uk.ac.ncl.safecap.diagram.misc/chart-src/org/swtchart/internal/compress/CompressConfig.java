...
public class CompressConfig {
	...
	public boolean equals(Object obj) {
		...
		final CompressConfig config = (CompressConfig) obj;
	 ...
	 * Sets the X range.
	 * 
	 * @param lower the lower value of x range
	 * @param upper the upper value of x range
	 */
	 ...
	 * Sets the Y range.
	 * 
	 * @param lower the lower value of y range
	 * @param upper the upper value of y range
	 */
	...
	public String toString() {
		return "pixelWidth = " + widthInPixels + ", " + "pixelHeight = " + heightInPixels + ", " + "xLowerValue = " + xLowerValue + ", "
				+ "xUpperValue = " + xUpperValue + ", " + "yLowerValue = " + yLowerValue + ", " + "yUpperValue = " + yUpperValue + ", "
				+ yLogScale;
	}
}
