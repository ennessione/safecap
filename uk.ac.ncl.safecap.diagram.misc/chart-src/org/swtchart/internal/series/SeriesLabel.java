...
public class SeriesLabel implements ISeriesLabel {
	...
	public String[] getFormats() {
		...
		final String[] copiedFormats = new String[formats.length];
	 ...
	 * @param h            the horizontal coordinate to draw label
	 * @param v            the vertical coordinate to draw label
	 * @param ySeriesValue the Y series value
	 * @param seriesIndex  the series index
	 * @param alignment    the alignment of label position (SWT.CENTER or
	 *                     SWT.BOTTOM)
	 */
	protected void draw(GC gc, int h, int v, double ySeriesValue, int seriesIndex, int alignment) {
		...
		if (alignment == SWT.CENTER) {
			final Point p = Util.getExtentInGC(font, text);
	...
	private boolean isDecimalFormat(String text) {
		final StringBuilder nonEscapedPart = new StringBuilder();
