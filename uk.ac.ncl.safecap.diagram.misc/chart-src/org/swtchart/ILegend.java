...
public interface ILegend {
	 ...
	 * <tt>SWT.RIGHT</tt>, the orientation of series on legend will be vertical. If
	 * the position is <tt>SWT.TOP</tt> or <tt>SWT.BOTTOM</tt>, the orientation will
	 * be horizontal.
	 * 
	 * @param position the position of legend that can be <tt>SWT.LEFT</tt>,
	 *                 <tt>SWT.RIGHT</tt>, <tt>SWT.TOP</tt> or <tt>SWT.BOTTOM</tt>.
	 */
	void setPosition(int position);

	/**
	 * Gets the rectangle associated with the given series id on legend. This method
	 * is typically used for mouse listener to check whether mouse cursor is on
	 * legend for a certain series.
	 * <p>
