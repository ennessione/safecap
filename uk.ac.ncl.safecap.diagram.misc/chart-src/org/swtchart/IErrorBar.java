...
public interface IErrorBar {
	...
	MINUS("Minus");
		 ...
		 * The constructor.
		 * 
		 * @param label error bar type label
		 */
	...
	/**
	 * Sets the error bar color. If <tt>null</tt> is given, default color will be
	 * set.
	 * 
	 * @param color the error bar color
	 */
	 ...
	 * 
	 * @param width line width to draw error bar
	 */
