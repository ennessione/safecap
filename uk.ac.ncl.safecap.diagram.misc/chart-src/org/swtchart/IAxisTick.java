...
public interface IAxisTick {
	...
	double MIN_GRID_STEP_HINT = 16;

	/**
	 * Sets the foreground color of axis tick.
	 *
	 * @param color the foreground color of axis tick
	 */
	 ...
	 *
	 * @param font the font for tick labels
	 */
	 ...
	 *
	 * @param isVisible true to make the tick marks visible
	 */
	 ...
	 *
	 * @param tickMarkStepHint the tick mark step hint with pixels (>
	 ...
	 *
	 * @param angle the angle in degree between 0 and 90. The default value is 0. If
	 *              setting 0, tick labels are horizontally shown. If setting 90,
	 *              tick labels are vertically shown.
	 */
