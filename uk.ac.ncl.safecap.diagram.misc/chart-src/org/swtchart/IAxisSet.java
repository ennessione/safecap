...
public interface IAxisSet {
	...
	/**
	 * Deletes the X Axis for given axis id. The series on the deleted axis will be
	 * moved onto the axis id '0'. The axis whose id is '0' cannot be removed.
	 * 
	 * @param id the axis id
	 * @throws IllegalArgumentException if the given axis id is '0', or if there is
	 *                                  no axis for the given id.
	 */
	void deleteXAxis(int id);

	/**
	 * Deletes the Y Axis for given id. The series on the deleted axis will be moved
	 * onto the axis id '0'. The axis whose id is '0' cannot be removed.
	 * 
	 * @param id the axis id
	 * @throws IllegalArgumentException if the given axis id is '0', or if there is
	 *                                  no axis for the given id.
