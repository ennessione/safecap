...
public interface ISeries {
	...
	/**
	 * Gets the Y series. If the Y series haven't been set yet, <tt>null</tt> will
	 * be returned.
	 * 
	 * @return the Y series
	 */
	 ...
	 * <p>
	 * X series and X date series are exclusive. X date series will be cleared by
	 * setting X series, and vice versa.
	 * 
	 ...
	 * 
	 * @param visible the visibility state in legend
	 */
