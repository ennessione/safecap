...
public class SubNodePropertySource extends NodePropertySource {
	protected SubSchemaNode node;
	...
	private Map<String, Overlap> overlaps;

	public SubNodePropertySource(final SubSchemaNode node) {
		super(node);
		this.node = node;
	}
